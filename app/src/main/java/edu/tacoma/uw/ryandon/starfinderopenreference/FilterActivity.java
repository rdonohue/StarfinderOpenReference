...
import edu.tacoma.uw.ryandon.starfinderopenreference.model.MembersContent;
    ...
    public class FilterActivity extends AppCompatActivity {
        ...
        private CheckBox classMystic, classTechnomancer, spellLevel0, spellLevel1, spellLevel2, spellLevel3, spellLevel4, spellLevel5, spellLevel6, schoolAbj, schoolConj, schoolDiv, schoolEnch, schoolEvoc, schoolIllu, schoolNec, schoolTran, rangePersonal, rangeTouch, rangeClose, rangeMedium, rangeLong, rangePlanetary, rangeSystem, rangePlane, castStandard, castMinute, castTenMinutes;
        private boolean classMysticCheck, classTechnomancerCheck, spellLevel0Check, spellLevel1Check, spellLevel2Check, spellLevel3Check, spellLevel4Check, spellLevel5Check, spellLevel6Check, schoolAbjCheck, schoolConjCheck, schoolDivCheck, schoolEnchCheck, schoolEvocCheck, schoolIlluCheck, schoolNecCheck, schoolTranCheck, rangePersonalCheck, rangeTouchCheck, rangeCloseCheck, rangeMediumCheck, rangeLongCheck, rangePlanetaryCheck, rangeSystemCheck, rangePlaneCheck, castStandardCheck, castMinuteCheck, castTenMinutesCheck;
